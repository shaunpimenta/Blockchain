...
async function sendMessage() {
    ...
    // console.log(account);
    // Call the sendMessage function on the contract
    account=web3.eth.getAccounts();
    console.log(account);
    await contract.methods.sendMessage(message).send({
      from: "0x38adFb8C56BeA6e91602D77658c336834f20B228", // Use the first account if multiple are available
    ...
    //     contract.methods.sendMessage(message).send({ from: senderAddress })
    //         .on('transactionHash', hash => {
    //             console.log('Transaction Hash:', hash);
    //         })
    //         .on('receipt', receipt => {
